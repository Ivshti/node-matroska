...
var tagClasses = {};
tagClasses[schema.byName.Segment] = require('./dom/segment3');
tagClasses[schema.byName.Attachments] = require('./dom/attachments');
tagClasses[schema.byName.AttachedFile] = require('./dom/attachedFile');
tagClasses[schema.byName.Tags] = require('./dom/tags');
tagClasses[schema.byName.Tag] = require('./dom/tag');
tagClasses[schema.byName.Targets] = require('./dom/targets');
tagClasses[schema.byName.SimpleTag] = require('./dom/simpleTag');
tagClasses[schema.byName.SeekHead] = require('./dom/seekHead');
tagClasses[schema.byName.Seek] = require('./dom/seek');
tagClasses[schema.byName.Info] = require('./dom/info');
tagClasses[schema.byName.Tracks] = require('./dom/tracks');
tagClasses[schema.byName.TrackEntry] = require('./dom/trackEntry');
tagClasses[schema.byName.Video] = require('./dom/video');
tagClasses[schema.byName.Audio] = require('./dom/audio');
tagClasses[schema.byName.CRC_32] = require('./dom/crc-32');
tagClasses[schema.byName.Cues] = require('./dom/cues');
tagClasses[schema.byName.CuePoint] = require('./dom/cuePoint');
tagClasses[schema.byName.CueReference] = require('./dom/cueReference');
tagClasses[schema.byName.CueTrackPositions] = require('./dom/cueTrackPositions');
